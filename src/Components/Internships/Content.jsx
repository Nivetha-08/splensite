      ...
      <section id='Content' className='p-5'>
        <div className="row p-lg-5 p-sm-3">
          <div className="col-lg-6 px-md-5 px-sm-0 my-auto">
            <p className='para1' style={{textAlign:"justify"}}>Splendenslab thrives not just by providing outstanding quality of service to our customers, but also from atracting the best and brightest young talent</p>
